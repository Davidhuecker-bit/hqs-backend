 ...
 * Einheitliches Datenformat fuer alle Marktprovider.
 * Keine undefined Werte.
 * Keine NaN Werte.
 * Provider-unabhaengig.
 */
...
function normalizeMarketData(raw, source, region) {
  ...
  const change = toNumberOrNull(raw.change ?? raw.d);
  const changesPercentage = toNumberOrNull(
