  ...
  try {
    ...
    await pool.query(
      `INSERT INTO pipeline_status
         (stage, last_run_at, input_count, success_count, failed_count, skipped_count, updated_at)
...
async function loadPipelineStatus() {
  try {
    ...
    const res = await pool.query(
      `SELECT stage, last_run_at, input_count, success_count, failed_count, skipped_count
